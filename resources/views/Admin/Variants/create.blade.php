    ...
    <form action="{{route('variants.store')}}" method="post" enctype="multipart/form-data">
       ...
       <div class="flex flex-col gap-4 p-3 shadow-lg rounded-lg border border-b-2 border-gray-600">
        <div>
            ...
            <input type="text" name="variant_name" id="name" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" value="{{old('variant_name')}}">
        ...
        <div>
            ...
            <input type="text" name="variant_rental_price" id="Rentprice" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">

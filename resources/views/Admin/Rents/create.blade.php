    ...
    <form action="{{route('rents.store')}}" method="post" enctype="multipart/form-data">
      ...
      <div>
        ...
        <div>
           ...
           <input type="text" name="from_date" id="from_date"  class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" value="{{ old('from_date') }}">
  ...
  $('#to_date').datepicker({
    ...
    maxDate: "+30D"
        ...
        <div>
            ...
            <input type="text"  name="to_date" id="to_date" onchange="setValues()" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" value="{{old('to_date')}}">

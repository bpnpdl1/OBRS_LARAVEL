...
<div>
   ...
   <div class="px-1 shadow-lg">
    ...
    <div>
        ...
        <p>Show <select name="" id="" class="text-sm m-2" wire:model="entries">  
      ...
      <div class="flex gap-2 items-center">
         <p>Select Status</p>
         <select name="" id="" class="rounded bg-gray-300 flex items-center py-1" wire:model="rentalstatus">
   ...
   <tbody>
      ...
      <tr >
         ...
         <td ><button class="bg-blue-500 rounded-md text-white px-1 text-xs scale-105"  wire:click="billbookdialog({{ $bike['id'] }})"  target="_blank"><small>View Bill Book</small></button></td>

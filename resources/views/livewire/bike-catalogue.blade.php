...
<div class="flex flex-row items-center px-8 ml-2">
    ...
    <div class="w-72 h-full border-gray-200 shadow border-2 hover:scale-105 hover:shadow-md ">
         ...
         <div class="grid grid-row-3 py-2 justify-center  hover:shadow-xl gap-8 ">
            ...
            <div>
                   ...
                   <select name="" id="" class="w-full rounded-sm text-center py-2" wire:model="priceorder" wire:onchange="orderprice('{{ $priceorder }}')">
            ...
            <div>
              ...
              <ul>
                ...
                <li class="px-6"> <input type="checkbox" wire:model="brandInputs" value="{{$brand->brand_name}}"> {{$brand->brand_name}}</li>
            ...
            <div class="w-60 flex flex-col pb-3" >
              ...
              <input type="range" name="" id="cc" min="{{ $min_cc }}" max="{{ $max_cc }}" onchange="showvalue()" wire:model="ccvalue"   >
               @if($ccvalue)
    ...
    <div class=" grid grid-cols-3 justify-evenly gap-6  mx-14 p-10 flex-1 hover:max-md:m-1 border-s-gray-500 border-s-[1px]">
    @foreach ($bikes as $bike)
        <div class="max-w-[20rem] mx-auto bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl hover:scale-110  ">
  ...
  <div class="p-4">
    ...
    <div class="mt-2">
     ...
     <input type="hidden" name="bike_id" value="{{ $bike->bike_id }}">
      <button  class="inline-block  w-full  text-center bg-gray-600 hover:bg-black text-white font-semibold py-2 px-4 rounded" type="submit">
      Rent Bike
      </button>
    </div>
    </form>

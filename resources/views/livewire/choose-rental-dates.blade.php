...
<div class="flex gap-3">
    ...
    <input type="date" min="{{  $from_min_date  }}"  wire:model="from_date"  name="from_date" max="" id="from_date" class="appearance-none leading-tight block bg-gray-100 rounded-md">
</div>
<div>
...
<button class="bg-gray-700 hover:bg-black w-full mt-2 font-semibold rounded-sm text-white p-2" type="submit">Find a Bike</button>
  </div>

                ...
                <div class="flex flex-row gap-4 justify-center">
                    <div>
                        ...
                        <input type="date" min="{{ date('Y-m-d') }}" name="" id=""
                            class="w-[100%] bg-slate-200 rounded" wire:model="from_date" value="{{ $from_date }}">
                    </div>
                    <div>
                        <p>To date</p>
                        <input type="date" name="" id="" class="w-[100%] bg-slate-200 rounded"
                            wire:model="to_date" value="{{ $to_date }}">
                    </div>
                </div>
                @if ($dateerror)
            ...
            <div class="bg-white">
                ...
                <div class="bg-white rounded relative p-2">
                    <button type="button" wire:click="billbookdialog(2)" class=" absolute top-2 right-2"> <i
                            class="fa fa-times hover:bg-black hover:text-white rounded-full p-1" aria-hidden="true"></i>
                    </button>
        ...
        <div class="bg-white inline-block p-6 rounded relative shadow-2xl shadow-black hover:scale-105">
            ...
            <div>
                ...
                <div class="flex flex-row justify-center gap-3 py-1">
                    ...
                    <button class="bg-violet-950 hovwe:bg-violet-500  text-sm px-3 py-0.5 rounded-sm text-white">Pay
                        with Khalti</button>
                </div>
            </div>
